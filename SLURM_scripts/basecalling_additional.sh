#!/bin/bash
#SBATCH --job-name=basecalling.0.7.0  # Job name
...
# |________________________________________________________________________________________________|
### Run basecalling
/project/sysviro/dorado-$VERSION-linux-x64/bin/dorado basecaller --trim adapters --estimate-poly-a -r sup $IN/$NAME/ > $OUT/"$NAME".sup.trimAdapters.dorado.$VERSION.bam

### Generate sequencing summary file 
/project/sysviro/dorado-$VERSION-linux-x64/bin/dorado summary $OUT/"$NAME".sup.trimAdapters.dorado.$VERSION.bam > $OUT/"$NAME".sup.trimAdapters.dorado.$VERSION.sequencing_summary.txt
# /================================================================================================\
# |                                             ENDING                                             |
# |________________________________________________________________________________________________|
