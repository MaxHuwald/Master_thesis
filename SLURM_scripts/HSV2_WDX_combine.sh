...
VERSION=1.1.1
IN1=/project/sysviro/users/Max/analyses/HSV2_333_ARPE19_WDX-3/HSV2_333_ARPE19_WDX-3.sup-allMods.trimAdapters.dorado."$VERSION".filtered.aligned.primary.bam
IN2=/project/sysviro/users/Max/analyses/HSV2_333_ARPE19_WDX-4/HSV2_333_ARPE19_WDX-4.sup-allMods.trimAdapters.dorado."$VERSION".filtered.aligned.primary.bam
NAME=HSV2_333_ARPE19_WDX-total_3_4
