#!/bin/bash
#SBATCH --job-name=trim_followup_hg38  # Job name
...
samtools view -bS - | \
samtools view -b -F2308 - > $OUT/"$NAME".sup.trimAdapters.dorado."$VERSION".trimmed_wiggle_${SLURM_ARRAY_TASK_ID}.aligned_hg38.primary.bam
